...
local phase = load_module("state/phase.lua")
local run_state = load_module("collectors/run_state.lua")
local zones = load_module("collectors/zones.lua")
local market = load_module("collectors/market.lua")
