...
eq(shaped_market.shop_items[1].joker, nil, "shell should omit inactive shop joker member")
eq(shaped_market.shop_items[1].consumable, nil, "shell should omit inactive shop consumable member")
eq(shaped_market.shop_items[1].voucher, nil, "shell should omit inactive shop voucher member")
eq(shaped_market.shop_items[1].pack, nil, "shell should omit inactive shop pack member")
