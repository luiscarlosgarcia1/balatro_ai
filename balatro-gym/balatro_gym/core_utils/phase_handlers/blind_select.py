...
from balatro_gym.core.boss_blinds import BOSS_BLINDS, BossBlindManager, select_boss_blind
...
class BlindSelectHandler:
    ...
    def _activate_boss_blind(self, base_chips: int) -> Tuple[float, Dict]:
        ...
        effects = self.boss_blind_manager.activate_boss_blind(boss_type, state_dict)
        ...
        if self.boss_blind_manager.boss_disabled_by_jokers(state_dict):
            self.boss_blind_manager.disable_boss_blind(
                self.state,
                self.game,
                restore_round_resources=True,
        ...
        info = {
            'boss_blind': blind.name,
            'boss_effect': blind.description,
            'chip_multiplier': effects['chip_mult'],
            'modifications': modifications,
            'boss_disabled': not self.state.boss_blind_active,
        }
