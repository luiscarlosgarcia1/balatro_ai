"""Provisional RL reward-shaping helpers.

This module is intentionally separate from source-of-truth Balatro logic.
It contains environment-facing reward shaping used for training signals.
"""
...
class ProvisionalRewardCalculator:
