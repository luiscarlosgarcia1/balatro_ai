...
Issues are tracked in Linear under the `Luis Garcia` team (`T`). Agents use the Linear API and have standing authority to manage the team's issues without human approval. See `docs/agents/issue-tracker.md`.
